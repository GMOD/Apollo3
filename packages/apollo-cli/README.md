...
```
USAGE
  $ apollo login [-a <value>] [-u <value>] [-p <value>]

FLAGS
  -a, --address=<value>   [default: http://localhost:3999] Address of Apollo server
...
_See code: [src/commands/login.ts](https://github.com/GMOD/Apollo3/blob/v0.0.0/src/commands/login.ts)_
...
_See code: [src/commands/logout.ts](https://github.com/GMOD/Apollo3/blob/v0.0.0/src/commands/logout.ts)_
...
_See code: [src/commands/status.ts](https://github.com/GMOD/Apollo3/blob/v0.0.0/src/commands/status.ts)_
<!-- commandsstop -->
